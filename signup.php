          ...
          <form method="post">
            <div class="wrapper">
                <div class="form2">
                  ...
                  <input type = "text" class="reginput" name = "name"  placeholder = "Name"> <br>
                              
                  <input type = "text" class="reginput" name = "email"  placeholder = "E-mail Address" > <br>
                                 
                  <input type = "text" class="reginput" name = "username"  placeholder = "Username" > <br>

                  <input type = "password" class="reginput" name = "password"  placeholder = "Password"> <br>

                   <input type = "password" class="reginput" name = "confirm"  placeholder = "Confirm"> <br>

                  <h1><input type = "submit"  class="regbtn" value = "Register" >
                  <input type = "button" class="regbtnn" value = "Cancel" onclick="window.location.href = '../LabActivity4/index.php';"></h1>
              </div>
            </div>  
...
<?php
  ...
  if (isset($_REQUEST['username'])){
    ...
    if($password !== $confirm){
      ...
      if($result){
        header("Location: ../LabActivity4/index.php");
      }else{
