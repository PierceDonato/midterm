...
<body>
    ...
    <div class="wrapper">
        <div class="form">
            <h1 id="hhhh"> USER LOGIN </h1>
            <form action="" method="post" name="login">
            <div class="container">
                <form class="form group" action="/authenticator.php">
                    <input class="textus" id="username" type="text" name="username" placeholder="Username">
                    <input class="textpa" id="password" type="password" name="password" placeholder="Password">
                </form>

                <center><button type="submit" class="btn" method="post" name="login">Login</button>
                    <button type="button" class="btnn" name="register" onclick="window.location.href='../LabActivity4/signup.php'">Register</button>
                </center>
                <!--<button type="button"  class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" onclick="openWin()">Login</button>-->
                <h1><a href="../LabActivity4/forgot.php"> FORGOT PASSWORD </a></h1>               
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){ 
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $link = "<script>window.open('http://localhost/LabActivity4/authenticator.php')</script>"; 
                            echo $link; 
...
<?php
    ...
    if (isset($_POST['username'])){
        ...
        if($rows==1){
            ...
            header("location: ../LabActivity4/authenticator.php");
