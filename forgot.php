...
<html lang="en">
<head>
    <title>Lab Activity 3 - Forgot Password</title> 
    ...
    <div class="wrapper">
        <div class="form">
            ...
            <div class="container">
                ...
                <br><br>
                <center><button type="submit" class="forbtn" method="post" name="changepassword">Change Password</button>
                <button type="button" class="forbtnn" name="register" onclick="window.location.href='../LabActivity4/index.php'">Cancel</button>
                </center>          
...
<?php
    ...
    if (isset($_POST['username'])){
        ...
        if($newpassword !== $confirmpassword){
            ...
            echo "<h4>Password Changed. Go to <a href='../LabActivity4/index.php'> Login <a></h4>";
